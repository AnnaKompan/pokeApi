...
</div>`;e.cardContainer.insertAdjacentHTML("beforeend",s)})(t)).join("");a.cardContainer.insertAdjacentHTML("beforeend",n)}function s(){let e=a.searchInput.value.trim().toLowerCase(),n=r;e&&(n=(0,t.filterByName)(n,e));let o=a.sortSelect.value;"asc"===o&&(n=(0,t.sortByNameAZ)(n)),"desc"===o&&(n=(0,t.sortByNameZA)(n)),"id-asc"===o&&(n=(0,t.sortByIdAsc)(n)),"id-desc"===o&&(n=(0,t.sortByIdDesc)(n)),i(n)}a.moreBtn.addEventListener("click",function(){n>=o?alert("No more Pokémons to load!"):c().then(e=>{i(e,!0)})}),document.addEventListener("DOMContentLoaded",function(){c().then(()=>{s()})}),a.searchInput.addEventListener("input",s),a.searchForm.addEventListener("submit",function(e){e.preventDefault(),s()}),a.sortSelect.addEventListener("change",s);
//# sourceMappingURL=pokeApi.bd3c9e93.js.map
