...
})({"3jDEn":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 52194;
var HMR_SECURE = false;
var HMR_ENV_HASH = "439701173a9199ea";
var HMR_USE_SSE = false;
module.bundle.HMR_BUNDLE_ID = "e83ca01a20686bc6";
"use strict";
...
},{}],"kqF9P":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _markup = require("../partials/markup");
...
var _filterSort = require("./filter_sort/filter_sort");
let allPokemons = [];
let limit = 20;
let offset = 0;
let totalCount = 0;
...
function fetchBatch() {
    return (0, _apiServiceDefault.default).fetchAll(limit, offset).then((data)=>{
...
function renderPokemonList(pokemonArray, append = false) {
    ...
    const markup = pokemonArray.map((p)=>(0, _markupDefault.default)(p)).join('');
...
function filterAndSort() {
    ...
    if (query) result = (0, _filterSort.filterByName)(result, query);
    // const selectedType = refs.filterSelect.value;
    // if (selectedType && selectedType !== 'all')
    //   result = filterByType(result, selectedType);
    const mode = refs.sortSelect.value;
    if (mode === 'asc') result = (0, _filterSort.sortByNameAZ)(result);
    if (mode === 'desc') result = (0, _filterSort.sortByNameZA)(result);
    if (mode === 'id-asc') result = (0, _filterSort.sortByIdAsc)(result);
    if (mode === 'id-desc') result = (0, _filterSort.sortByIdDesc)(result);
...
},{"../partials/markup":"bPTix","../js/api-service":"4sSKZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./filter_sort/filter_sort":"k0bMY"}],"bPTix":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>pokemonCardTpl);
const refs = {
    cardContainer: document.querySelector('.card-container')
};
...
exports.default = {
    ...
    fetchAll (limit = 20, offset = 0) {
        return fetch(`${BASE_URL}/pokemon?limit=${limit}&offset=${offset}`).then((res)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"k0bMY":[function(require,module,exports,__globalThis) {
...
function filterByName(pokemonArr, query) {
    ...
    return pokemonArr.filter((pokemon)=>pokemon.name.toLowerCase().startsWith(lowerQuery));
}
...
},{}]},["3jDEn","kqF9P"], "kqF9P", "parcelRequire2e6b", {})

//# sourceMappingURL=pokeApi.20686bc6.js.map
